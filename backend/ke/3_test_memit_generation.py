...
def blue_title(text: str) -> str:
    """
    Print section titles in blue.
    """
...
def generate_completions(
    ...
    prompt: str,
    n: int = 10,
    max_new_tokens: int = 20,  # HARD LIMIT: max 20 tokens
):
    """
...
def test_memit_generation_en():
    ...
    Section titles are printed in blue.
    """
